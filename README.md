...
## Environments
- Preview: https://main--sausaxen-medtronic-da--aemysites.aem.page/
- Live: https://main--sausaxen-medtronic-da--aemysites.aem.live/
- Block Library: https://main--sausaxen-medtronic-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-medtronic-da` directory in your favorite IDE and start coding :)
